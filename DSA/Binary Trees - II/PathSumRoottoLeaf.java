...
public class Solution {
	...
	private static void helper(BinaryTreeNode<Integer> root, String path, int sum, int k) {
		if (root == null)
			return;
		...
		helper(root.left, path + root.data + " ", sum + root.data, k);
		helper(root.right, path + root.data + " ", sum + root.data, k);
