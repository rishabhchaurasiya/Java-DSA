...
public class Solution {
    public static BinaryTreeNode<Integer> buildTreeHelper(int[] postOrder, int[] inOrder,int siPost,int eiPost,int siIn,int eiIn){
        ...
        int leftsubtreelength=siInLeft-eiInLeft+1;
        int eiPostLeft=siPostLeft+leftsubtreelength-1;
        int siPostRight=eiPostLeft+1;
        
        BinaryTreeNode<Integer> left=buildTreeHelper(postOrder,inOrder,siPostLeft,eiPostLeft,siInLeft,eiInLeft);
        BinaryTreeNode<Integer> right=buildTreeHelper(postOrder,inOrder,siPostRight,eiPostRight,siInRight,eiInRight);
        root.left=left;
        root.right=right;
        return root;
